/*
 * File:   conversor_analogic.c
 * Author: Pedro
 *
 * Created on 31 de Julho de 2021, 15:06
 */
...
unsigned int tempoAceso = 10;    // O tempo em que o LED ficará aceso
float porcentagem = 0; // Porcentagem de tempo padrão que o LED ficará aceso
...
void main(void) {
    ...
    // Configura todos os pinos D como saída
    TRISD = 0b00000000;
    
    while (1) {
        ADCON0bits.GO = 1; // Inicia a conversão de analógico para digital
